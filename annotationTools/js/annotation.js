...
function annotation(anno_id) {
    ...
    // Xavier's changes. 0 means that it is a polygon. 1 means it is a mask.
    ...
    this.DeletePolygon = function () {
        ...
        // Finally we remove the segmentation mask if there was any
    ...
    this.FillPolygon = function () {
        ...
        else { // If it is a segmentation
            //ClearMask(this.polygon_id);
