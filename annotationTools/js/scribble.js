...
function InitializeScribbleMode(tag_button, tag_canvas) {
    ...
    html_str = '<div id= "polygonDiv" class="annotatemenu">Polygon<br />Tool \
...
function scribble_canvas(tag) {
    ...
    this.resizeandsaveImage = function (urlSource, namedest, urlDest, scale, fwidth, fheight, dir, callback, annotation_ended, blur) {
        ...
        console.log("about to launch resizeand saveimage" + "urlsource: " + urlSource +
			"namedest: " + namedest +
			"urlDest: " + urlDest +
			"scale: " + scale +
			"posx: " + poslx +
        ...
        $.ajax({
            ...
            if (callback == 0) {
                ...
                if (window.XMLHttpRequest) {
                    ...
                    console.log("ABOUT TO LAUNCH SEGMENT.cgi  " + "url: " + url +
                     "THE ARGS: " + imagetoSegmentURL + "&" + Nobj + "&" + scribble_canvas.colorseg + "&" + tmpPath);
                    ...
                    console.log(collectionName);
					scribble_canvas.resizeandsaveImage(collectionName + "/", resp, collectionName + "/", 1. / scale, main_image.width_orig, main_image.height_orig, 1, 2, annotation_ended, "false");
